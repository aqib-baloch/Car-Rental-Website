        ...
        <div>
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            <p data-aos="fade-up" className="text-center sm:px-20">
              Download our app now for a seamless car rental experience. Quick
              bookings, affordable rates, and hassle-free rides – all at your
              fingertips! 📲 Available on the App Store & Google Play
            </p>
            <div
              data-aos="fade-up"
