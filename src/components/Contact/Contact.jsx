          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6">
            <div className="col-span-2 space-y-3">
              ...
              <p className="text-gray-400">
                Join us in revolutionizing car rentals! Whether you are a
                business or an individual, we offer seamless solutions tailored
                to your needs. Let&apos;s make car rentals easier, faster, and more
                efficient together! 
              </p>
            </div>
